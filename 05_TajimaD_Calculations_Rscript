...
#This R script include 
  # 1 - Calculating Tajima's D for Europe and North America in PopGenome
  # 2 - Plotting results (but see Fig 3 plotting script for full re-creation of plot)

#This R script is for Tajima's D calculations for Ssa19 (the same script was used for other chromosomes)
#Script generated by T.Kess and modified here
...
##Nice plot of data combined - did multiple plots togther for chromosomes - see script for Fig 3 combined plots
